...
@Component({
  selector: 'page-tabsbottom2',
  templateUrl: 'tabsbottom2.html',
})
export class Tabsbottom2Page {
  ...
  constructor(public navCtrl: NavController, public dummyTabs: DummyTabs, public navParams: NavParams) {
    this.tabSettings = {
      totalAngle: 180,
      gapAngle: 2,
      startAngle: -1,
